...
plot(c2015, ext = vt)
plot(nlcd, ext = vt, col=rainbow(8))
zoom(plot(c2015, ext = vt))


nyc <- county %>% filter(GEOID == 36061)
chitt <- county %>%filter(GEOID == 50007)
plot(nlcd, ext = nyc, col=rainbow(8))
plot(nlcd, ext = chitt, col=rainbow(8))
plot(c2015, ext = nyc)
plot(c2015, ext = chitt)
